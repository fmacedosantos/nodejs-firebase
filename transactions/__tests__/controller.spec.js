...
describe('Transaction controller', () => {
  ...
  test('given find transactions by user, when succes, then return transactions', (done) => {
  ...
  test('given find transactions by user, when fail, return error status 500', (done) => {
